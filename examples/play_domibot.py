...
save every game's log.
    ...
    python examples/play_domibot.py --games 10 --players 4 --checkpoint checkpoints/domibot1/domibot_v4.4.pt --save-logs
    python examples/play_domibot.py --games 10 --checkpoints checkpoints/domibot1/domibot_v4.3.pt checkpoints/domibot1/domibot_v4.4.pt
